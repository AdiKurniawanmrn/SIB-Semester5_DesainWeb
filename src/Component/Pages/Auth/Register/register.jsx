        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content rounded-4 shadow">
            ...
            <div className="modal-body p-5 pt-0">
              ...
              <hr className="my-4" />
              <h2 className="fs-5 fw-bold mb-3">Or use a Register third-party</h2>
              <button
              ...
              <form />
              <p className="d-flex justify-content-center">All ready have an account? <Link to="/login">Login</Link></p>
            </div>
          </div>
        </div>
      </div>
